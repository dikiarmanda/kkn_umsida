...
<head>
    ...
    <link
        rel="stylesheet"
        href="<?= base_url() ?>public/vendors/ti-icons/css/themify-icons.css" />
    <link rel="stylesheet" href="<?= base_url() ?>public/vendors/css/vendor.bundle.base.css" />
    <link
        rel="stylesheet"
        href="<?= base_url() ?>public/vendors/font-awesome/css/font-awesome.min.css" />
    <link
        rel="stylesheet"
        href="<?= base_url() ?>public/vendors/mdi/css/materialdesignicons.min.css" />
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <!-- <link rel="stylesheet" href="<?= base_url() ?>public/vendors/datatables.net-bs4/dataTables.bootstrap4.css"> -->
    <link
        rel="stylesheet"
        href="<?= base_url() ?>public/vendors/datatables.net-bs5/dataTables.bootstrap5.css" />
    <link
        rel="stylesheet"
        href="<?= base_url() ?>public/vendors/ti-icons/css/themify-icons.css" />
    <link
        rel="stylesheet"
        type="text/css"
        href="<?= base_url() ?>public/js/select.dataTables.min.css" />
        ...
        <div class="row p-0 m-0 proBanner" id="proBanner">
            <div class="col-md-12 p-0 m-0">
                <div
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <a
                            href="https://www.bootstrapdash.com/product/skydash-admin-template/"><i class="ti-home me-3 text-white"></i></a>
